"use strict"; // Enforces strict mode for syntax
...
// Event handlers that run when the cash or bill value changes
cashBox.addEventListener("change", runTheRegister);
billBox.addEventListener("change", runTheRegister);

// Function that resets the values on the web page
...
function calcChange(changeValue) {
  ...
  // Determines the number of nickels
...
// Function that determines the largest whole number of currency units that
...
// Function that displays a numeric value as a text string in the format ##.##
